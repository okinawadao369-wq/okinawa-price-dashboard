...
export const monitoringSources: MonitoringSource[] = [
  ...
  { id: "gdelt", category: "国際ニュース", source: "GDELT DOC 2.0", url: "https://blog.gdeltproject.org/gdelt-doc-2-0-api-debuts/", updateCadence: "起動時または手動更新で1d/2d/3d/7d検索", status: "ニュース検索", quality: "unknown", dashboardUse: "登録済み。取得・要旨化・台帳化が完了するまで observed にしない（URL登録と取得を混同しない）" },
  ...
  { id: "dod_budget", category: "米国防", source: "DoD Comptroller Budget Materials", url: "https://comptroller.defense.gov/Budget-Materials/Budget2026/", updateCadence: "予算発表/議会審議時", status: "ニュース検索", quality: "unknown", dashboardUse: "登録済み。取得・確認前は observed にしない（DFAS/DTMO/DoD FMR同様）" },
  { id: "dfas_pay_tables_2026", category: "米軍給与", source: "DFAS 2026 Military Pay Tables", url: "https://www.dfas.mil/Pressroom/Article/4391719/2026-military-pay-tables-on-dfas-website/", updateCadence: "年次/手当更新時", status: "公式ページ", quality: "unknown", dashboardUse: "公式ページ登録済み。確認後に米軍・軍属家族の基本給、BAS、特殊手当を価格心理・支払い余力の上限根拠へ反映" },
  { id: "dfas_bas", category: "米軍給与", source: "DFAS Basic Allowance for Subsistence", url: "https://militarypay.defense.gov/pay/allowances/bas.aspx", updateCadence: "年次", status: "公式ページ", quality: "unknown", dashboardUse: "公式ページ登録済み。確認後にBASを生活費補助として把握し、食品・外食・家族向けサービス価格心理へ反映" },
  { id: "dtmo_bah_oha_cola", category: "米軍手当", source: "DTMO BAH/OHA/OCONUS COLA Allowances", url: "https://www.travel.dod.mil/Allowances/BAH-Rate-Lookup/", updateCadence: "年次/随時", status: "公式手動確認", quality: "unknown", dashboardUse: "手動確認後にBAH/OHA/COLAを住宅費・海外生活費の公式根拠として、沖縄米軍家族の可処分所得推定へ反映" },
  { id: "dod_fmr_housing_allowances", category: "米軍手当", source: "DoD FMR Volume 7A Housing Allowances", url: "https://comptroller.defense.gov/Portals/45/documents/fmr/current/07a/07a_26.pdf", updateCadence: "規則改定時", status: "公式ページ", quality: "unknown", dashboardUse: "公式PDF登録済み。確認後にOHA/BAH/COLAの制度根拠を明示し、推定値と公式制度の混同を防ぐ" },
  { id: "dod_rss", category: "米国防", source: "DoD official news RSS", url: "https://www.war.gov/News/RSS/index.html/", updateCadence: "随時", status: "ニュース検索", quality: "unknown", dashboardUse: "登録済み。RSS取得・要旨化が完了するまで observed にしない" },
  { id: "usfj", category: "在日米軍", source: "U.S. Forces Japan official updates", url: "https://www.usfj.mil/", updateCadence: "随時", status: "ニュース検索", quality: "unknown", dashboardUse: "登録済み。取得・要旨化が完了するまで observed にしない" },
  { id: "mlr", category: "沖縄米軍", source: "12th Marine Littoral Regiment official site", url: "https://www.12thmlr.marines.mil/", updateCadence: "随時", status: "ニュース検索", quality: "unknown", dashboardUse: "登録済み。取得・要旨化が完了するまで observed にしない" },
...
export const sectorPriceBenchmarks: SectorPriceBenchmark[] = [
  { id: "restaurant", sector: "飲食・外食", sourceFamily: "BLS CPI Food Away From Home / GDELT企業価格ニュース", observedSignal: "外食CPI、賃金、ガソリン、企業値上げ報道", updateCadence: "月次+日次ニュース", quality: "estimated", dashboardUse: "自動取得・可視化は段階導入。現状は推計ベンチマークとして扱う（未確認値を observed と誤認しない）" },
