...
export const usPriceBenchmarks: UsPriceBenchmark[] = [
  ...
  { industryId: "ft_4d", baseLow: 150, baseHigh: 350, quality: "estimated", sourceFamily: "Elective 3D/4D/HD boutique ultrasound packages with video and heartbeat add-ons", lastReviewed: "2026-06-06", rationale: "2026 public ranges commonly show standard 3D/4D packages around $150-$250 and premium HD/video/heartbeat-bear bundles around $200-$350." },
  ...
  { industryId: "baby_keepsake", baseLow: 40, baseHigh: 80, quality: "estimated", sourceFamily: "Heartbeat plush / keepsake add-on public listings", lastReviewed: "2026-06-06", rationale: "Heartbeat animal add-ons commonly appear around $40-$60, with bundled keepsake packages reaching higher." },
