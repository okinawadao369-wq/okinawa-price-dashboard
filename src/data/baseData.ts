...
export const newsTopics: NewsTopic[] = [
  ...
  { id: "fed_policy", label: "FRB・金利・インフレ期待", query: '("Federal Reserve" OR FOMC OR Powell OR "interest rates" OR "rate cut" OR "rate hike") (inflation OR jobs OR dollar OR yields)', weight: 1.05, scoreRole: "marketRisk" },
  { id: "treasury_fiscal", label: "米財政・国債・政府閉鎖", query: '("U.S. Treasury" OR "federal debt" OR "government shutdown" OR "debt ceiling" OR "Treasury yields") (Congress OR budget OR deficit)', weight: 1.0, scoreRole: "marketRisk" },
  { id: "global_energy_shipping", label: "エネルギー・物流・海上リスク", query: '(oil OR gasoline OR shipping OR "Red Sea" OR Houthi OR freight OR supply chain) (price OR attack OR disruption OR inflation)', weight: 1.0, scoreRole: "marketRisk" },
  { id: "us_service_prices", label: "米国サービス価格・生活費", query: '("restaurant prices" OR childcare OR babysitting OR rent OR healthcare OR "service prices") (inflation OR expensive OR consumer OR wages)', weight: 1.0, scoreRole: "consumerStress" },
  { id: "corporate_pricing", label: "米企業価格・小売/外食動向", query: '(Walmart OR Target OR Costco OR McDonald\'s OR Starbucks OR "retail sales" OR "consumer spending") (prices OR inflation OR demand OR discount)', weight: 0.95, scoreRole: "consumerStress" },
  { id: "defense_budget_pacific", label: "米国防予算・太平洋抑止", query: '("defense budget" OR Pentagon OR "Pacific Deterrence Initiative" OR "Indo-Pacific Command") (Japan OR Okinawa OR Guam OR Taiwan OR China)', weight: 1.15, scoreRole: "forwardPosture" },
  { id: "okinawa_operations", label: "沖縄米軍訓練・運用・事件事故", query: '(Okinawa OR Kadena OR Futenma OR "Camp Foster" OR "Camp Hansen") ("U.S. military" OR Marines OR Air Force OR exercise OR incident OR training)', weight: 1.15, scoreRole: "okinawaBase" },
  { id: "us_japan_command", label: "日米指揮統合・USFJ再編", query: '("U.S. Forces Japan" OR USFJ OR "Joint Force Headquarters" OR "Japan Self-Defense Forces" OR JSDF) (command OR integration OR interoperability OR alliance OR headquarters)', weight: 1.25, scoreRole: "forwardPosture" },
  { id: "first_island_chain", label: "第一列島線・12th MLR・海兵隊再編", query: '("Marine Littoral Regiment" OR "12th MLR" OR "first island chain" OR "stand-in force" OR "Camp Hansen" OR "Camp Schwab") (Okinawa OR Japan OR Taiwan OR China OR exercise)', weight: 1.3, scoreRole: "okinawaBase" }
];
