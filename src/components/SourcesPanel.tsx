export function SourcesPanel() {
  const sources = [
    ...
    { label: "DoD Comptroller FY2026 Budget Materials / Pacific Deterrence Initiative", url: "https://comptroller.defense.gov/Budget-Materials/" },
    { label: "DoD / War.gov RSS: 米軍作戦・同盟・即応性ニュース", url: "https://www.war.gov/News/RSS/index.html/" },
    ...
    { label: "U.S. Forces Japan: 沖縄コミュニティ連携・共同パトロール・USFJ公式更新", url: "https://www.usfj.mil/" },
    { label: "12th Marine Littoral Regiment: 沖縄の前方展開・MLR機能", url: "https://www.12thmlr.marines.mil/" },
    { label: "Mearsheimer / offensive realism model reference: 大国政治・海洋障壁・第一列島線モデル", url: "https://www.defensepriorities.org/explainers/grand-strategy-geography/" },
